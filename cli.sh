...
show_help() {
	...
	arg_desc "help" "Show possible arguments"
	arg_desc "linux" "Build the game for linux"
	arg_desc "run" "Build the game for linux and run it natively"
	arg_desc "clean" "Clean the obj and bin directories"
}
